<template>
  <!-- <v-card flat>
    <v-card-text class="title"
      >Decode the message (insert or generate):</v-card-text
    >
    <v-card-actions>
      <v-col>
        <v-text-field
  ...
  <my-greypractice-template :props="propObject"></my-greypractice-template>
</template>

<script>
import GreyPracticeTemplate from "./GreyPracticeTemplate";
// import { greyCodeLogic } from "../../../codelogic/othercodes/grey";
export default {
  data() {
    return {
      propObject: {
        welcomeMsg: "Декодуйте повідомлення",
        codeMsg: "Повідомлення для декодування"
      }
    };
  },
  components: {
    "my-greypractice-template": GreyPracticeTemplate
  }
  // data() {
  //   return {
  //     model: "",
